 ...
 * Generated: 2026-01-31T23:07:01.757Z
 * 
...
enum IndicatorType {
    iCustom_ = MAKE_IND(0, 0, 0, IND_CUSTOM),
    iAC_ = MAKE_IND(0, 1, 1, IND_AC),
    iAD_volume = MAKE_IND(1, 1, 1, IND_AD),
    iADX_period = MAKE_IND(1, 3, 1, IND_ADX),
    iADXWilder_period = MAKE_IND(1, 3, 1, IND_ADXW),
    iAlligator_jawP_jawS_teethP_teethS_lipsP_lipsS_method_price = MAKE_IND(8, 3, 0, IND_ALLIGATOR),
    iAMA_period_fast_slow_shift_price = MAKE_IND(5, 1, 0, IND_AMA),
    iAO_ = MAKE_IND(0, 1, 1, IND_AO),
    iATR_period = MAKE_IND(1, 1, 1, IND_ATR),
    iBands_period_shift_deviation_price = MAKE_IND(4, 3, 0, IND_BANDS),
    iBearsPower_period = MAKE_IND(1, 1, 1, IND_BEARS),
    iBullsPower_period = MAKE_IND(1, 1, 1, IND_BULLS),
    iBWMFI_volume = MAKE_IND(1, 1, 1, IND_BWMFI),
    iCCI_period_price = MAKE_IND(2, 1, 1, IND_CCI),
    iChaikin_fast_slow_method_volume = MAKE_IND(4, 1, 1, IND_CHAIKIN),
    iDEMA_period_shift_price = MAKE_IND(3, 1, 0, IND_DEMA),
    iDeMarker_period = MAKE_IND(1, 1, 1, IND_DEMARKER),
    iEnvelopes_period_shift_method_price_deviation = MAKE_IND(5, 2, 0, IND_ENVELOPES),
    iForce_period_method_volume = MAKE_IND(3, 1, 1, IND_FORCE),
    iFractals_ = MAKE_IND(0, 2, 0, IND_FRACTALS),
    iFrAMA_period_shift_price = MAKE_IND(3, 1, 0, IND_FRAMA),
    iGator_jawP_jawS_teethP_teethS_lipsP_lipsS_method_price = MAKE_IND(8, 4, 1, IND_GATOR),
    iIchimoku_tenkan_kijun_senkou = MAKE_IND(3, 5, 0, IND_ICHIMOKU),
    iMomentum_period_price = MAKE_IND(2, 1, 1, IND_MOMENTUM),
    iMFI_period_volume = MAKE_IND(2, 1, 1, IND_MFI),
    iMA_period_shift_method_price = MAKE_IND(4, 1, 0, IND_MA),
    iMACD_fast_slow_signal_price = MAKE_IND(4, 2, 1, IND_MACD),
    iOBV_volume = MAKE_IND(1, 1, 1, IND_OBV),
    iOsMA_fast_slow_signal_price = MAKE_IND(4, 1, 1, IND_OSMA),
    iRSI_period_price = MAKE_IND(2, 1, 1, IND_RSI),
    iRVI_period = MAKE_IND(1, 2, 1, IND_RVI),
    iSAR_step_maximum = MAKE_IND(2, 1, 0, IND_SAR),
    iStdDev_period_shift_method_price = MAKE_IND(4, 1, 1, IND_STDDEV),
    iStochastic_K_D_slowing_method_price = MAKE_IND(5, 2, 1, IND_STOCHASTIC),
    iTEMA_period_shift_price = MAKE_IND(3, 1, 0, IND_TEMA),
    iTriX_period_price = MAKE_IND(2, 1, 1, IND_TRIX),
    iVIDyA_momentum_smooth_shift_price = MAKE_IND(4, 1, 0, IND_VIDYA),
    iVolumes_volume = MAKE_IND(1, 1, 1, IND_VOLUMES),
    iWPR_period = MAKE_IND(1, 1, 1, IND_WPR)
};
...
template<typename PURGER, typename T>
class ArrayPurger {
public:
