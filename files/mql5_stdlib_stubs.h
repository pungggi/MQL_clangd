 ...
 * Generated: 2026-04-21T22:28:03.893Z
 * 
...
struct LUID { unsigned int LowPart; int HighPart; };
struct FILE_ID_128 { unsigned char Identifier[16]; };
// MOUSEINPUT and INPUT_TYPE are defined late in the file;
// forward-declare them so earlier code that references them compiles.
struct MOUSEINPUT;
struct INPUT_TYPE;
...
typedef void (*PlotFucntion)(void* cbdata);  // MQL5 original spelling
...
// DirectX types used before their full definitions
...
// Template forward declarations needed by Generic collections
...
class IList<T>;
class Slot<TValue>;
class IComparable<CKeyValuePair<TKey,TValue>*>;
class IComparer<CKeyValuePair<TKey,TValue>*>;
class IMap<TKey,TValue>;
class ISet<T>;
class IEqualityComparable<T>;
class ICollection<T>;
class ICollection<CKeyValuePair<TKey,TValue>*>;
class IComparer<T>;
class IEqualityComparer<T>;
class ENUM_OBJECT;
class ENUM_COLOR_FORMAT;
class ENUM_ALIGNMENT;
class DXVertexLayout;
class ENUM_DX_PRIMITIVE_TOPOLOGY;
class ENUM_DX_SHADER_TYPE;
class EN_COLOR_SCHEME;
class ENUM_TIMEFRAMES;
class CDateTime;
class ENUM_DATE_MODES;
class ENUM_PROGRAM_TYPE;
class ENUM_ALIGN_MODE;
class ENUM_BORDER_TYPE;
struct MqlDateTime;
class ENUM_INIT_PHASE;
class ENUM_ACCOUNT_MARGIN_MODE;
class ENUM_TYPE_TREND;
class ENUM_ORDER_TYPE_TIME;
class ENUM_APPLIED_PRICE;
class ENUM_MA_METHOD;
class ENUM_STO_PRICE;
class T;
class TKey;
class TValue;
class TItem;
class ENUM_RED_BLACK_TREE_NODE_TYPE;
class DoubleToStringFunction;
class ENUM_AXIS_TYPE;
class ENUM_CURVE_TYPE;
class ENUM_LINE_STYLE;
class ENUM_LINE_END;
class ENUM_POINT_TYPE;
class PlotFucntion;
class ENUM_APPLIED_VOLUME;
struct MqlParam;
class HedgeType;
class OperatorType;
class EnAndMethod;
...
class MfCompositionType;
class ENUM_ORDER_TYPE;
class ENUM_ORDER_STATE;
class ENUM_POSITION_TYPE;
struct MqlTick;
class ENUM_SYMBOL_TRADE_EXECUTION;
class ENUM_SYMBOL_CALC_MODE;
class ENUM_SYMBOL_TRADE_MODE;
class ENUM_SYMBOL_SWAP_MODE;
class ENUM_DAY_OF_WEEK;
struct MqlTradeRequest;
struct MqlTradeResult;
struct MqlTradeCheckResult;
class ENUM_ORDER_TYPE_FILLING;
class ENUM_LOG_LEVELS;
class PVOID;
class HANDLE;
...
public:
    ...
    void ProjectionMatrixSet(float fov, float aspect_ratio, float z_near, float z_far);
...
public:
    ...
    bool SeriesUpdate(const uint pos, const double & value, const string descr = nullptr, const uint clr = 0);
...
public:
    ...
    bool ValueUpdate(const uint pos, const double value, const string descr = nullptr, const uint clr = 0);
...
public:
    ...
    DXVector2 tcoord;
    DXColor vcolor;
    static const DXVertexLayout s_layout;
};
...
public:
    virtual ~CDXShader();
    bool Create(int context, ENUM_DX_SHADER_TYPE shader_type, string source, string entry_point);
...
public:
    virtual ~CDXTexture();
    bool Create(int context, string path, uint data_x = 0, uint data_y = 0, uint data_width = 0, uint data_height = 0);
    bool Create(int context, ENUM_DX_FORMAT format, uint width, uint height, const uint & data, uint data_x = 0, uint data_y = 0, uint data_width = 0, uint data_height = 0);
    virtual void Shutdown(void);
};
...
public:
    ...
    virtual bool InitIndicators(CIndicators * indicators = nullptr);
protected:
    ulong m_magic;
...
public:
    ...
    virtual bool InitSignal(CExpertSignal * signal = nullptr);
    virtual bool InitTrailing(CExpertTrailing * trailing = nullptr);
    virtual bool InitMoney(CExpertMoney * money = nullptr);
    virtual bool InitTrade(ulong magic, CExpertTrade * trade = nullptr);
...
public:
    ...
    bool Buy(const double volume, const string symbol = nullptr, double price = 0.0, const double sl = 0.0, const double tp = 0.0, const string comment = "");
    bool Sell(const double volume, const string symbol = nullptr, double price = 0.0, const double sl = 0.0, const double tp = 0.0, const string comment = "");
    bool BuyLimit(const double volume, const double price, const string symbol = nullptr, const double sl = 0.0, const double tp = 0.0, const ENUM_ORDER_TYPE_TIME type_time = ORDER_TIME_GTC, const datetime expiration = 0, const string comment = "");
    bool BuyStop(const double volume, const double price, const string symbol = nullptr, const double sl = 0.0, const double tp = 0.0, const ENUM_ORDER_TYPE_TIME type_time = ORDER_TIME_GTC, const datetime expiration = 0, const string comment = "");
    bool SellLimit(const double volume, const double price, const string symbol = nullptr, const double sl = 0.0, const double tp = 0.0, const ENUM_ORDER_TYPE_TIME type_time = ORDER_TIME_GTC, const datetime expiration = 0, const string comment = "");
    bool SellStop(const double volume, const double price, const string symbol = nullptr, const double sl = 0.0, const double tp = 0.0, const ENUM_ORDER_TYPE_TIME type_time = ORDER_TIME_GTC, const datetime expiration = 0, const string comment = "");
...
public:
    ...
    int CopyTo(CKeyValuePair<TKey,TValue>*, const int dst_start = 0);
...
template<typename T>
class IComparable : public IEqualityComparable<T> {
};
