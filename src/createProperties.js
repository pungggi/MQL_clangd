...
// ============================================================================
// CLANGD KNOWN FALSE-POSITIVE SUPPRESSIONS
// Shared with the CodeActionProvider so it can suggest re-running config.
// ============================================================================
const CLANGD_BASE_SUPPRESSIONS = [
    'pp_file_not_found',
...
async function CreateProperties(force = false) {
    ...
    try {
        ...
        let finalSuppressions = CLANGD_BASE_SUPPRESSIONS;
        if (shouldPreserve && fs.existsSync(clangdConfigPath)) {
            ...
            finalSuppressions = mergeClangdSuppressions(CLANGD_BASE_SUPPRESSIONS, existingSuppressions);
        }
